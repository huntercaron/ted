      ...
      <div>
          ...
          <SubmitArrow submitted={this.state.imageMode}>
            ...
            >
              <polygon
                fill="#000000"
                fillRule="evenodd"
                points="8.81 .647 13.655 5.492 13.655 5.934 8.81 10.779 7.824 9.793 11.258 6.393 .684 6.393 .684 5.05 11.275 5.05 7.824 1.633"
              />
            </svg>
          </SubmitArrow>
        </InputContainer>
        ...
        <TedVis xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1010 10505">
          {this.state.tedData.map((talk, i) => {
            if (talk.foundLines.length <= 0) return <g key={i} />
            ...
            return (
              <g
                key={i}
                transform={`translate(5, ${(10500 / this.state.tedData.length) *
                  i +
                  5})`}
              ...
              >
                ...
                {talk.foundLines.map((line, i) => (
                  <React.Fragment key={i}>
                    <circle
                      cy="0"
                      cx={(timeToMinutes(line) / width) * 1000}
                      r="2"
                    />
                  </React.Fragment>
                ))}
